...
var Core = /** @class */ (function () {
    ...
    Core.prototype.createMintAssetTransaction = function (params) {
        ...
        return new MintAsset_1.MintAsset({
            ...
            output: new AssetMintOutput_1.AssetMintOutput({
                supply: supply == null ? codechain_primitives_1.U64.MAX_VALUE : codechain_primitives_1.U64.ensure(supply),
    ...
    Core.prototype.createIncreaseAssetSupplyTransaction = function (params) {
        var shardId = params.shardId, assetType = params.assetType, recipient = params.recipient, supply = params.supply, _a = params.approvals, approvals = _a === void 0 ? [] : _a;
